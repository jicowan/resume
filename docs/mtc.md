...
As the first Solution Architect hired in Illinois, I was responsible for covering and growing the mid-West territory for AWS. As AWS grew, I shifted to cover the largest enterprise accounts in the region by revenue. My primary job was to educate customers about cloud computing and convince them that it was safe, trustworthy, and reliable. Oftentimes, this involved creating PoCs, reference architectures, and conducting well-architected reviews, product overviews, and deep-dives.

### Cloud Evangelist (Microsoft Technology Centers) 

***Microsoft** (June 2012 - June 2013)*

As a Cloud Evangelist, I was responsible for educating customers about Microsoft's continuing investment in cloud computing and the infrastructure it built to deliver secure and reliable services to enterprises and consumers alike. This job involved giving tours of Microsoft's North American datacenters which helped to illustrate Microsoft's ongoing commitment to cloud computing and operational excellence. The experience included a briefing about Microsoft's continuum of services such Azure and Office 365 and how these services could increase their agility, transforming IT into a business-enabler which would ultimately help them gain a competitive advantage in the marketplace.
